<x-layout-admin title="Riwayat Reservasi">
    <div class="flex-1 min-h-screen overflow-y-auto" 
        ...
        <div class="max-w-6xl mx-auto px-4 mb-12">
            ...
            <!-- Tabel Reservasi -->
            <div class="overflow-x-auto shadow-md border border-gray-200 rounded-lg">
                <table class="min-w-full text-sm text-gray-700">
                    ...
                    <tbody class="bg-white font-semibold">
                        ...
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="px-4 py-3">
                                <span class="bg-blue-100 text-blue-700 px-2 py-1 rounded-full text-xs">{{ $reservasi->jam }}</span>
                            </td>
                            <td class="px-4 py-3">
