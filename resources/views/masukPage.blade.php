...
<div class="flex items-center justify-center min-h-screen bg-cover bg-center bg-gray-900/70 bg-blend-darken font-['Inter']" style="background-image: url('/images/bgAnimal.jpg')">
    ...
    <div class="relative w-full max-w-md px-4">
        @if(session('success'))
            <div id="alert-3" class="absolute -top-16 left-4 right-4 flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 shadow-md z-10 transition-opacity duration-500" role="alert">
